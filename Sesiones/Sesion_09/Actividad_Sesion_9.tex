...
\title{%
  ...
  Actividad Práctica 9: Métodos de Nueva Generación: MARCOS, EDAS, CODAS y CoCoSo\\
...
\begin{brandbox}{Contexto de la Actividad}
  Espacio reservado para describir la actividad práctica de la Sesión 9. El alumno deberá aplicar los modelos matemáticos revisados en clase a un problema de logística y cadena de suministro.
\end{brandbox}
