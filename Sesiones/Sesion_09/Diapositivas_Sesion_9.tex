...
% --- METADATOS ---
\title[Herramientas Multicriterio - Sesión 9]{Herramientas Multicriterio para Toma de Decisiones}
\subtitle{Sesión 9: Métodos de Nueva Generación: MARCOS, EDAS, CODAS y CoCoSo}
...
\begin{frame}{Objetivos de la Sesión}
    \begin{block}{Al finalizar esta sesión, el estudiante de doctorado será capaz de:}
        \begin{itemize}
            \item \textbf{Analizar críticamente} los fundamentos teóricos del tema: Métodos de Nueva Generación: MARCOS, EDAS, CODAS y CoCoSo.
...
\begin{frame}{Fundamentos de Métodos de Nueva Generación: MARCOS, EDAS, CODAS y CoCoSo}
    \begin{itemize}
        \item Espacio reservado para el contenido teórico principal de la Sesión 9.
