...
\title{%
  ...
  Actividad Práctica 6: Teoría de la Utilidad Multiatributo (MAUT) y Decisiones bajo Incertidumbre\\
...
\begin{brandbox}{Contexto de la Actividad}
  Espacio reservado para describir la actividad práctica de la Sesión 6. El alumno deberá aplicar los modelos matemáticos revisados en clase a un problema de logística y cadena de suministro.
\end{brandbox}
