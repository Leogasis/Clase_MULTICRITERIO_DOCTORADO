# Plan de Clase Detallado: Sesión 6
...
Al finalizar esta sexta sesión, el estudiante de doctorado será capaz de:
...
* **Entrega:** En esta sesión se recopila y califica el **E2 (Caso Práctico 2: Jerarquización por Distancia: TOPSIS vs. VIKOR)** (20%).
* **Paso de Control:** Los alumnos están trabajando activamente en el desarrollo del **E3 (Caso Práctico 3: Relaciones de Superación)** a entregarse en la Sesión 8 (Inicio del PIA).
