...
\title{%
  ...
  Actividad Práctica 12: Toma de Decisiones Multicriterio con Big Data, Machine Learning y XAI\\
...
\begin{brandbox}{Contexto de la Actividad}
  Espacio reservado para describir la actividad práctica de la Sesión 12. El alumno deberá aplicar los modelos matemáticos revisados en clase a un problema de logística y cadena de suministro.
\end{brandbox}
