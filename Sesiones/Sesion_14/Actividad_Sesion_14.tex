...
\title{%
  ...
  Actividad Práctica 14: Validación, Robustez, Replicabilidad y Revisión por Pares en MCDM\\
...
\begin{brandbox}{Contexto de la Actividad}
  Espacio reservado para describir la actividad práctica de la Sesión 14. El alumno deberá aplicar los modelos matemáticos revisados en clase a un problema de logística y cadena de suministro.
\end{brandbox}
