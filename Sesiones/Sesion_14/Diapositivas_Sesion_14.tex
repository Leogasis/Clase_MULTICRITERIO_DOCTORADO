...
% --- METADATOS ---
\title[Herramientas Multicriterio - Sesión 14]{Herramientas Multicriterio para Toma de Decisiones}
\subtitle{Sesión 14: Validación, Robustez, Replicabilidad y Revisión por Pares en MCDM}
...
\begin{frame}{Objetivos de la Sesión}
    \begin{block}{Al finalizar esta sesión, el estudiante de doctorado será capaz de:}
        \begin{itemize}
            \item \textbf{Analizar críticamente} los fundamentos teóricos del tema: Validación, Robustez, Replicabilidad y Revisión por Pares en MCDM.
...
\begin{frame}{Fundamentos de Validación, Robustez, Replicabilidad y Revisión por Pares en MCDM}
    \begin{itemize}
        \item Espacio reservado para el contenido teórico principal de la Sesión 14.
