...
\title{%
  ...
  Actividad Práctica 11: Modelos Híbridos: Integración de MCDM con Optimización (NSGA-II)\\
...
\begin{brandbox}{Contexto de la Actividad}
  Espacio reservado para describir la actividad práctica de la Sesión 11. El alumno deberá aplicar los modelos matemáticos revisados en clase a un problema de logística y cadena de suministro.
\end{brandbox}
