...
\title{%
  ...
  Actividad Práctica 4: Paradigma de Distancia Geométrica: TOPSIS, VIKOR y variantes\\
...
\begin{brandbox}{Contexto de la Actividad}
  Espacio reservado para describir la actividad práctica de la Sesión 4. El alumno deberá aplicar los modelos matemáticos revisados en clase a un problema de logística y cadena de suministro.
\end{brandbox}
