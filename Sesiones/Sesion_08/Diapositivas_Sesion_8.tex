...
% --- METADATOS ---
\title[Herramientas Multicriterio - Sesión 8]{Herramientas Multicriterio para Toma de Decisiones}
\subtitle{Sesión 8: MCDM bajo Incertidumbre: Teoría de Sistemas Grises (GRA) y Conjuntos Aproximados (Rough Sets)}
...
\begin{frame}{Objetivos de la Sesión}
    \begin{block}{Al finalizar esta sesión, el estudiante de doctorado será capaz de:}
        \begin{itemize}
            \item \textbf{Analizar críticamente} los fundamentos teóricos del tema: MCDM bajo Incertidumbre: Teoría de Sistemas Grises (GRA) y Conjuntos Aproximados (Rough Sets).
...
\begin{frame}{Fundamentos de MCDM bajo Incertidumbre: Teoría de Sistemas Grises (GRA) y Conjuntos Aproximados (Rough Sets)}
    \begin{itemize}
        \item Espacio reservado para el contenido teórico principal de la Sesión 8.
