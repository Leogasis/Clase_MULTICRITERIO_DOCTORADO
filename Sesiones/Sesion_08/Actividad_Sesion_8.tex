...
\title{%
  ...
  Actividad Práctica 8: MCDM bajo Incertidumbre: Teoría de Sistemas Grises (GRA) y Conjuntos Aproximados (Rough Sets)\\
...
\begin{brandbox}{Contexto de la Actividad}
  Espacio reservado para describir la actividad práctica de la Sesión 8. El alumno deberá aplicar los modelos matemáticos revisados en clase a un problema de logística y cadena de suministro.
\end{brandbox}
