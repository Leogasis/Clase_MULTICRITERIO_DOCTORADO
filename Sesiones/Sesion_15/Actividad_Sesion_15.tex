...
\title{%
  ...
  Actividad Práctica 15: Presentaciones Finales, Defensa de Proyectos y Retroalimentación Académica\\
...
\begin{brandbox}{Contexto de la Actividad}
  Espacio reservado para describir la actividad práctica de la Sesión 15. El alumno deberá aplicar los modelos matemáticos revisados en clase a un problema de logística y cadena de suministro.
\end{brandbox}
