...
\title{%
  ...
  Actividad Práctica 7: Lógica Difusa y Conjuntos Difusos en MCDM: Fuzzy AHP y Fuzzy TOPSIS\\
...
\begin{brandbox}{Contexto de la Actividad}
  Espacio reservado para describir la actividad práctica de la Sesión 7. El alumno deberá aplicar los modelos matemáticos revisados en clase a un problema de logística y cadena de suministro.
\end{brandbox}
