...
\title{%
  ...
  Actividad Práctica 13: Sostenibilidad, Logística Verde y Criterios ESG en Toma de Decisiones\\
...
\begin{brandbox}{Contexto de la Actividad}
  Espacio reservado para describir la actividad práctica de la Sesión 13. El alumno deberá aplicar los modelos matemáticos revisados en clase a un problema de logística y cadena de suministro.
\end{brandbox}
