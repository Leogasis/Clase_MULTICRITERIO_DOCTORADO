...
\title{%
  ...
  Actividad Práctica 5: Paradigma de Superación (Outranking): Métodos ELECTRE y PROMETHEE\\
...
\begin{brandbox}{Contexto de la Actividad}
  Espacio reservado para describir la actividad práctica de la Sesión 5. El alumno deberá aplicar los modelos matemáticos revisados en clase a un problema de logística y cadena de suministro.
\end{brandbox}
