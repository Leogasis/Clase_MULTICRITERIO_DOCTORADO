...
% --- METADATOS ---
\title[Herramientas Multicriterio - Sesión 5]{Herramientas Multicriterio para Toma de Decisiones}
\subtitle{Sesión 5: Paradigma de Superación (Outranking): Métodos ELECTRE y PROMETHEE}
...
\begin{frame}{Objetivos de la Sesión}
    \begin{block}{Al finalizar esta sesión, el estudiante de doctorado será capaz de:}
        \begin{itemize}
            \item \textbf{Analizar críticamente} los fundamentos teóricos del tema: Paradigma de Superación (Outranking): Métodos ELECTRE y PROMETHEE.
...
\begin{frame}{Fundamentos de Paradigma de Superación (Outranking): Métodos ELECTRE y PROMETHEE}
    \begin{itemize}
        \item Espacio reservado para el contenido teórico principal de la Sesión 5.
